...
public class JwstFeedFragment extends Fragment implements FeedAdapter.FeedClickListener {
    ...
    public JwstFeedFragment() { }

    public static JwstFeedFragment getInstance() {
        return new JwstFeedFragment();
    }
