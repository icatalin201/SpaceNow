...
public class RocketPastLaunchesFragment extends Fragment implements RocketLaunchesAdapter.RocketLaunchClickListener {

    private Unbinder unbinder;
    private AppCompatActivity appCompatActivity;
    private RocketLaunchesAdapter rocketLaunchesAdapter;
    private MainViewModel mainViewModel;
    @BindView(R.id.rocket_launches_recycler)
    RecyclerView rocketLaunchesRecycler;

    public RocketPastLaunchesFragment() { }

    public static RocketPastLaunchesFragment getInstance() {
        return new RocketPastLaunchesFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        mainViewModel.getPastLaunches().observe(this, launchDtos -> {
            if (launchDtos != null) {
