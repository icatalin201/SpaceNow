...
public class LaunchConverters {
    ...
    @TypeConverter
    public static PadDto padFromString(String pad) {
        return pad == null ? null : gson.fromJson(pad, PadDto.class);
    }

    @TypeConverter
    public static String padToString(PadDto padDto) {
        return padDto == null ? null : gson.toJson(padDto);
    }
